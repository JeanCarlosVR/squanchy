...
module.exports = {
  name: "unmute",
  category: "moderation",
  description: "Remove silence from a user to prevent them from sending messages.",
  usage: "<prefix>unmute <mentionUser>",
  ...
  const unmuteemoji = client.emojis.cache.get("585788304210001920");
    ...
    let muterole = message.guild.roles.cache.find(element => element.name === "Muted");
